...
key = {"8bit":["Penny","Brock","Squeak", "Piper"],
        ...
        "Frank": ["Colette", "Primo", "Griff", "Chester"],
        "Gale": ["Janet", "Amber", "T>Thrower", "Penny"],
        "Gene": ["Mr. P", "Penny", "Tara", "Eve", "Charlie", "Belle"],
        "Gigi": ["Finx", "Pierce", "Alli", "Trunk", "Sirius"],
        "Glowy": ["Eve", "Barley", "Mr. P", "Gene", "Bonnie"],
        ...
        "Sirius": ["Buster", "Leon", "Buzz", "Penny", "Edgar"],
        "Spike": ["T>Thrower", "Squeak", "Carl", "Piper"],
        "Sprout": ["Mico", "Mortis", "Edgar", "Frank"],
        "Squeak": ["T>Assassins", "Ash", "Kenji", "Mortis", "Buzz"],
